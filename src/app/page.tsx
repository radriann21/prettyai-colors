    ...
    <main className="max-w-6xl min-h-screen mx-auto flex flex-col px-4 xl:px-0 py-8 relative font-hind">
      ...
      <section className="mb-8 w-full flex items-center justify-between">
        <div>
          ...
          <p className="font-semibold text-sm">Generate color palettes and visualize them on real time.</p>
        </div>
        <div>
          <a href="https://github.com/radriann21/prettyai-colors" target="_blank" rel="noreferrer">
